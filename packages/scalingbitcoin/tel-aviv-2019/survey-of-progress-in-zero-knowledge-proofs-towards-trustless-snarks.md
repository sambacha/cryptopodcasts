...
Succinctness is that the proof size is small, so polylogarithmic, in the
...
CS proofs were computationally-sound proofs, the first step towards
...
This GKR isn't zero-knowledge, XZZPS 2019 tried to make it

...
(From slide - I have often found myself using the `_call` helper. I have
...
Then we can verify that the scriptSig works based off of the
...
Q - I am one of the people working on bitcoinjs-lib and SegWit support
is really hard.

...
will need to address that and do something about it.
...
discover instructions to route to that node in grey. In fact he will run
...
another guy as a trampoline node and she is only going to care about how

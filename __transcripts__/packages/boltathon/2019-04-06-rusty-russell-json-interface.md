...
We need to get the ID. Every JSON RPC command has an ID. We read
...
eventually most of the power of c-lightning is going to move out to
plugins.
...
Q - Is there anything for community plugins to get rated on
trustworthiness?

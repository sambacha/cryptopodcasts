...
That concludes the mnemonics part. There's now a 512 bit seed which
...
Say you want to derive children from these master keys. This scheme
...
So imagine the top-left were the master keys. If the master keys are
